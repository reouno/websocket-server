...
/* package websocket-server-0.1.0.0 */
#define VERSION_websocket_server "0.1.0.0"
#define MIN_VERSION_websocket_server(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "websocket-server-0.1.0.0-I7u4whFyaF5DcxUIKC3QwR"

#define CURRENT_PACKAGE_KEY "websocket-server-0.1.0.0-I7u4whFyaF5DcxUIKC3QwR"
